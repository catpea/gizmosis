...
// Generated from <gizmo tag="go-node-cable">.
  ...
  "contract": {
    "props": [
      ...
      },
      {
        ...
        "of": "",
        "values": [],
        "default": ".go-node-graph-edge-layer",
        "reflect": false,
        "readonly": false,
        "required": false,
        "optional": false,
...
export class GoNodeCable extends HTMLElement {
  ...
  get svgSelector() { return this.getAttribute('svg-selector') || '.go-node-graph-edge-layer'; }
  ...
  render() {
    ...
    if (!group || group.parentNode !== layer) {
      ...
      group.setAttribute('class', 'go-node-graph-edge-group');
      group.dataset.edgeId = id;
      const hit = document.createElementNS(SVG_NS, 'path');
      hit.setAttribute('class', 'go-node-graph-edge-hit');
      hit.dataset.edgeId = id;
      const line = document.createElementNS(SVG_NS, 'path');
      line.setAttribute('class', 'go-node-graph-edge');
    ...
    group.querySelector('.go-node-graph-edge-hit')?.setAttribute('d', d);
    group.querySelector('.go-node-graph-edge')?.setAttribute('d', d);
  ...
  _findLayer() {
    const host = this.closest('go-node-graph') || this.getRootNode();
...
GoNodeCable.gizmoManifest = gizmoManifest;
GoNodeCable.gizmoDiagnostics = gizmoDiagnostics;

export function defineGoNodeCable(tag = "go-node-cable") {
  installNodeEditorStyles();
  if (!customElements.get(tag)) customElements.define(tag, GoNodeCable);
  return customElements.get(tag);
}

if (typeof customElements !== 'undefined') defineGoNodeCable();
