...
export const gizmoManifest = {
  ...
  "about": {
    "summary": "SVG-backed pan/zoom node editor for effects graphs. Nodes are stored in graph/world coordinates. The viewport applies pan and zoom. The component coordinates generated node-card and node-cable Web Components. Browser mechanics are compiled from declarative Gizmo XML and supported by the gizmo/node-editor helper library.",
    "text": "SVG-backed pan/zoom node editor for effects graphs. Nodes are stored in graph/world coordinates. The viewport applies pan and zoom. The component coordinates generated node-card and node-cable Web Components. Browser mechanics are compiled from declarative Gizmo XML and supported by the gizmo/node-editor helper library."
  },
  "terms": [
    {
      "name": "world",
